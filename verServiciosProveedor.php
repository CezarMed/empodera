  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Servicios del Proveedor Asignados</h1>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Listado de servicios asignados al proveedor</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
          <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                <?php 
                  ...
                  where scp.proveedorname=$idRegistro";
                  ...
                  <tr>
                      ...
                      <td><?php echo $registro['folioServicio'] ?></td>
                      <td><?php echo $registro['fechaAsignacion'] ?></td>
                      <td><?php echo $registro['observaciones'] ?></td>
                      <td>$<?php echo number_format($registro['montoFacturable'], 2, '.', ',') ?></td>
                      <td><?php echo $registro['descripcionEstatus'] ?></td>
                      <td><?php if ($estatus!=5) {  ?>
                          <a class="btn btn-success btn-sm" href="detalleDeServicio?idBeneficiario=<?php echo $registro['idBeneficiario'] ?>&idServicio=<?php echo $registro['idServicio'] ?>&idCuenta=<?php echo $registro['idCuenta'] ?>">                              
                              Ingresar al detalle
                          </a>
                        <?php } else { ?>
