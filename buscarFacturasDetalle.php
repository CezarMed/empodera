...
INNER joiN tipoestatus te On te.idEstatus=fxml.estatus
                   where r.idRegistro=$idProveedor";
                  ...
                  <tr>
                      ...
                      <td>
                <a class="btn btn-info btn-sm" href="detalleFacturaProveedorDatos?idFactura=<?php echo $registro['idFacturas']; ?>">
                              <i class="fas fa-info">
                              </i>
                              Ver detalles
                          </a>
