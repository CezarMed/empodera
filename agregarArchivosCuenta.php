...
include('class/altaDocumentosCuentas.php');
...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>BIBLIOTECA DE ARCHIVOS DE LA CUENTA</h1>
          </div>
          <div class="col-sm-6">
  ...
  <?php } ?>
    ...
    <section class="content">
        ...
        <div class="card card-default">
         <form action="" method="POST" autocomplete="off" enctype="multipart/form-data">
          <div class="card-header">
            <h3 class="card-title">Archivos importantes de la Cuenta</h3>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                 ...
                 <input type="text" class="form-control" id="concepto" name="concepto" placeholder="Concepto del Archivo" required>
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Biblioteca de la cuenta</h3>
          <div class="card-tools">
          ...
          <table class="table table-striped projects">
              ...
              <tbody>
                <?php
                  ...
                  $query = "SELECT * from documentoscuentas ds
                            INNER JOIN usuarios u on u.idUsuario=ds.idSubio
                            where ds.idCuenta=$idCuenta";
                            $res = mysqli_query($con,$query);
                            while ($registro = mysqli_fetch_array($res)) {
                  ?>
                  <tr>
