  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>EDICIÓN DE MONTO AL SERVICIO</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Empodera</a></li>
              <li class="breadcrumb-item active">EDICIÓN DE MONTO</li>
            </ol>
          </div>
        </div>
      </div>
      ...
      <div class="container-fluid">
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">Editar Monto de Servicio</h3>
          </div>
          ...
          <div class="card-body">
            <div class="row" >
              <div class="col-md-12">
                ...
                <input type="text" class="form-control" id="monto" name="monto" value="<?php echo $monto ?>" onkeyup="eliminarEspacio()">
            ...
            <button type="submit" class="btn btn-success">Editar Montos</button>
            </div>             
            </div>                      
          </div> 
        </div>
