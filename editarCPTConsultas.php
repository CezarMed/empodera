  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Edición de CPT Consultas</h1>
          </div>
          <div class="col-sm-6">
      ...
      <div class="card">
        ...
        <div class="card-body p-0" >
          <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                <?php 
                  $query="SELECT * FROM consultasdescripcion";
...
<script type="text/javascript">
  function editaCpt(){
    ...
    var titulo=$('#titulo').val(); 
            $.ajax({
            url: 'consultas/editarCptConsultas.php',
            type: "POST",
            data: {"idCpt":idCpt, "titulo":titulo},
            success: function (cmb) {
               // alert(cmb);
               window.location="editarCPTConsultas?do=1";
            }
        });  
