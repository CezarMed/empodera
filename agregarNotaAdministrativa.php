  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>CREACIÓN DE NOTAS ADMINISTRATIVAS</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Empodera</a></li>
              <li class="breadcrumb-item active">Notas Administrativas</li>
            </ol>
          </div>
        </div>
      </div>
        ...
        <div class="card card-default">
          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                 ...
                 <input type="hidden" class="form-control" id="altaNotaAdmin" name="altaNotaAdmin" value="altaNotaAdmin">
                </div>
              </div>

              <div class="col-md-3">
                <div class="form-group">
                  <label>Fecha de registro de la nota</label>
                  <input type="text" class="form-control" id="fechaAlta" name="fechaAlta" value="<?php echo date('Y-m-d') ?>" readonly>
                </div>
              </div>
              <div class="col-md-3">
                <div class="form-group">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  <label>Agregar las notas correspondientes</label>
                 <textarea class="form-control" rows="3" id="contenidonota" name="contenidonota" placeholder="Agregar las notas correspondientes" maxlength="2000" onkeyup="countChars(this);" required></textarea>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                 ...
                 <select class="custom-select form-control-border" id="importancianota" name="importancianota" required>
            ...
            <button type="submit" class="btn btn-success">Generar nota administrativa</button>
            </div> 
          </div>          
        </div>
        </div>
