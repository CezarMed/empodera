  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Solicitud de Cotización de segundo ciclo</h1>
          </div>
          <div class="col-sm-6">
                  ...
                  <tr>
                    <td>
                      ...
                      <td>
                            ...
                            <a class="btn btn-info btn-sm" href="responderCotizacion?idCotizacion=<?php echo $idCotizacion; ?>&proveedor=no&Ext=si">
                              <i class="fas fa-info">
                              </i>
                              Responder Cotización de segundo ciclo
                          </a>
