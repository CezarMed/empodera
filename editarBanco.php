...
?>
  <div class="content-wrapper">
    ...
    <?php 
    $idBanco=$_GET['id'];
    $query = "SELECT * from bancos where idBanco=$idBanco";
    $res = mysqli_query($con,$query);
    $extraido= mysqli_fetch_array($res);
    $nombreBanco=$extraido['NombreBanco'];
    ?>
        ...
        <div class="card card-default">
         <form action="" method="POST" autocomplete="off">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                 ...
                 <input type="hidden" id="actualizaBanco" name="actualizaBanco" value="actualizaBanco">
          ...
          <div class="card-footer">
            <button type="submit" class="btn btn-success">Actualizar nombre banco</button>
          </div>          
        </div>
      </form>
        </div>
