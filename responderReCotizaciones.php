  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Re cotizaciones</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Empodera</a></li>
              <li class="breadcrumb-item active">Re cotizaciones</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <table class="table table-striped projects">
              ...
              <tbody>
                <?php 
                  ...
                  INNER JOIN registros r on r.idRegistro=sc.idProveedor where sc.estatus=3 and scm.elegido=1 and scm.estatus=80 GROUP BY scm.idCotizacion, sm.folioSolicitud ';
                  ...
                  <tr>
                    <td>
                      ...
                      <td>
                            ...
                            <a class="btn btn-info btn-sm" href="responderReCotizacion?idCotizacion=<?php echo $idCotizacion; ?>">
                              <i class="fas fa-info">
                              </i>
                              Responder re Cotizacion
                          </a>
