...
?>
  <div class="content-wrapper">
      ...
      <div class="container-fluid">
        <div class="card card-default">
          <?php
            ...
            $archivoCotizacion=$extraido2['archivoCotizacion'];

            // obtengo el id de servicio cerrado
            $query3 = "SELECT * from servicioscerradosproveedor
            where idServicio=$idServicio";
            $res3 = mysqli_query($con,$query3);
            $extraido3= mysqli_fetch_array($res3);
            $idCierre=$extraido3['idCierre'];

            // obtengo el idCotizacion actual
            $query3 = "SELECT * FROM solicitudcotizaciones sc
            INNER JOIN solicitudcotizacionesmedicamentos scm
            where scm.elegido=1 and idSolicitudMedicamentos=$idSolicitudMedicamentos";
            $res3 = mysqli_query($con,$query3);
            $extraido3= mysqli_fetch_array($res3);
            $idCotizacionAnterior=$extraido3['idCotizacion'];
    ...
    <form action="asignaProveedorCotizacionSegundoCiclo" method="POST" autocomplete="off" enctype="multipart/form-data">
        ...
        <div class="card card-default">
          ...
          <div class="card-body">
            <div class="row" id="dynamic_field">
             ...
             $queryMedicamento2 = "SELECT * FROM solicitudcotizacionesmedicamentos sm 
             inner join medicamentossolicitados ms on ms.idMedicamento=sm.idProductoSolicitud
            ...
            while ($medicamentos22 = mysqli_fetch_array($resMedicamento2)) {
              ...
              <div class="card-body" id="<?php echo "row".$i; ?>">
                ...
                <div class="form-group">
                  <div class="input-group">
                    ...
                    <input type="checkbox" class="form-check-input" id="check<?php echo $i ?>" name="activar[]" value="<?php echo $medicamentos22['idMedicamentoSolicitud'] ?>" checked>
                  </div>                
                </div>
              </div>
              <div class="col-md-2">
              ...
              <div class="col-md-1">
                <div class="form-group">
                  <div class="input-group">
                    <input type="text" class="form-control" name="costo[]" value="<?php echo $medicamentos22['costo']; ?>" readonly>
                  </div>                
                </div>
              </div>
              <div class="col-md-1">
                <div class="form-group">
                  <div class="input-group">
                    <input type="text" class="form-control" name="costototal[]" value="<?php echo $medicamentos22['costototal']; ?>" readonly>
                  </div>                
                </div>
              </div>
              <div class="col-md-2">
             ...
             <?php } ?>             
              ...
              <?php if ($archivoCotizacion!='') { ?>

              <div class="card-footer">
                    <a class="btn btn-info" href="<?php echo $archivoCotizacion ?>" target="_blanck">
        ...
        <?php } ?>
              ...
              <div class="card-footer">
                <input type="hidden" id="idCotizacionAnterior" name="idCotizacionAnterior" value="<?php echo $idCotizacionAnterior ?>">
                    ...
                    <input type="hidden" id="idCierre" name="idCierre" value="<?php echo $idCierre ?>">
            ...
            <button type="submit" class="btn btn-success"> <i class="fas fa-check">
                              </i> Aceptar Re Cotización</button>
            <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#rechazarCotizacion" id="btnActivate"> <i class="fas fa-times">
                              </i> Rechazar Re Cotización
                      </button>
...
<script type="text/javascript">
  function editarProveedor(){
    ...
    var idCotizacion=$('#idCotizacion').val();
        ...
        $.ajax({
            url: 'consultas/asignaProveedorCotizacionSegundoCiclo.php',
            type: "POST",
            data: {"idCierre":idCierre,"idProveedor":idProveedor, "idCotizacion":idCotizacion},
...
<div id="rechazarCotizacion" class="modal fade" role="dialog">
  <div class="modal-dialog">
    <!-- Contenido del modal -->
    <div class="modal-content">
      <div class="modal-header"><b>RECHAZAR COTIZACION DE SEGUNDO CICLO</b>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
      <div class="modal-body">
        <div class="col-md-12">
                <div class="form-group">
                 <input type="hidden" class="form-control" id="idCotizacion" name="idCotizacion" value="<?php echo $idCotizacion?>" readonly>
                  <div class="alert alert-info alert-dismissible">
                  <h5><i class="icon fas fa-info"></i> Importante!</h5>
                 La cotización se cancelara y ya no estara disponible para una posible asignación, de igual manera la cotización no afectara al proveedor asignado al servicio en este momento.
                </div>
                
                  </div>
        </div>

        <button type="button" class="btn btn-danger" onclick="cancelarCotizacion()">Cancelar cotización de segundo ciclo</button>
      </div>
    </div>
  </div>
</div>
...
<script type="text/javascript">
  function cancelarCotizacion(){
    var idCotizacion=$('#idCotizacion').val();
        ...
        $.ajax({
            url: 'consultas/cancelaCotizacionSegundoCiclo.php',
            type: "POST",
            data: {"idCotizacion":idCotizacion},
            success: function (cmb) {
               // alert(cmb);
               window.location = "responderReCotizacionesExt?do=5";
            }
        });        
  }
</script>
