  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Asignar contribución a un servicio del beneficiario</h1>
          </div>
          <div class="col-sm-6">
    ...
    <section class="content" id="datosCopagos">
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Contribuciónes enviadas a la cuenta del Beneficiario</h3>
              ...
              <tbody>
                <?php
                  ...
                  <tr>
                    ...
                    <td><b>$<?php echo $registro['montoAprobado'] ?></b></td>
                    <td><b>$<?php echo $registro['montoSaldo'] ?></b></td>
      ...
      <div class="modal-body">
        ...
        <div class="col-md-12">
                <div class="form-group">
                 ...
                 <input type="number" class="form-control"id="montoAsigna" name="montoAsigna" placeholder="Asigna un monto">
                  </div>
        </div>
    ...
    if (montoAsigna>montoAutoriza){
       ...
       $(function() {
                  ...
                  $(document).ready(function() {
                    Toast.fire({
                      icon: 'error',
                      title: ' El monto '+montoAsigna+' que se pretende asignar no puede ser mayor que el disponible ' +montoAutoriza
                    })
                  });
                  }); 
      } else {
                $.ajax({
            url: 'consultas/asignarContribucion',
            type: "POST",
               ...
               $('.modal-backdrop').remove();
                 $(function() {
                  ...
                  $(document).ready(function() {
                    Toast.fire({
                      icon: 'success',
                      title: ' La contribución se ASIGNO correctamente, si queda pendiente aun podra seguir asignandose'
                    })
                  });
                  });
            }
