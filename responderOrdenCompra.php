...
include('class/respondeOrdenCompra.php');
$NuUs = new respondeOrdenCompra_class();
if ($_POST) {
$NuUs->responderOrdenCompra();
}
$hoy=date('Y-m-d');
?>
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>SOLICITUD DE MEDICAMENTOS (ORDEN DE COMPRA)</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Empodera</a></li>
              <li class="breadcrumb-item active">Orden de Compra solicitud</li>
            </ol>
          </div>
        </div>
      </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" id="fechaRespuestaOrden" name="fechaRespuestaOrden" class="form-control" value="<?php echo $hoy ?>" readonly>
        ...
        <div class="card card-default">
          ...
          <div class="card-body">
            <div class="row">
              ...
              <?php
              $queryCoti= "SELECT * FROM actualizacioncotizacion where idCotizacion=$idCotizacion";
              $resCoti = mysqli_query($con,$queryCoti);
              $filasCoti = mysqli_num_rows($resCoti);
            ...
            where sc.idProveedor=$idProveedor and scm.elegido=1 and sc.idCotizacion=$idCotizacion";
            ...
            while ($medicamentos22 = mysqli_fetch_array($resMedicamento2)) {
              ...
              <div class="card-body" id="<?php echo "row".$i; ?>">
                ...
                <div class="form-group">
                  <div class="input-group">
                    ...
                    <input type="hidden" class="form-control" name="proveedor" value="<?php echo $medicamentos22['nombreComercial']; ?>" >
                  </div>                
                </div>              </div>
              <div class="col-md-2">
                <div class="form-group">
              ...
              <?php if ($filasSolicitadas<$filasTotales) { 
                $readonlyCosto=""; } else { $readonlyCosto="readonly"; } ?>
              <div class="col-md-1">
                <div class="form-group">
                  <div class="input-group">
                    <input type="text" class="form-control" name="costo[]" value="<?php echo $medicamentos22['costo']; ?>" <?php echo $readonlyCosto ?>>
                  </div>                
                </div>
              </div>
              <div class="col-md-1">
                <div class="form-group">
                  <div class="input-group">
                    <input type="text" class="form-control" name="costototal[]" value="<?php echo $medicamentos22['costototal']; ?>" <?php echo $readonlyCosto ?>>
                  </div>                
                </div>
              </div>
              <div class="col-md-2">
             ...
             <?php 
             if ($filasCoti<1) {
             if ($filasSolicitadas<$filasTotales) { ?>
             <div class="row">
              <div class="col-md-12">
                <div class="form-check">
                    <input type="checkbox" class="form-check-input" id="recotizacion" name="recotizacion" value="si">
                    <label class="form-check-label" for="exampleCheck3"><b>RE COTIZACIÓN (enviar a empodera para evaluación)</b></label>
                  </div>
              </div>
              </div>
              <?php } } else { ?><div class="col-sm-12">
              <div class="alert alert-info alert-dismissible">
                  <h5><i class="icon fas fa-check"></i> Ups!</h5>
                  Ya no es posible crear una recotización</a>
                </div>
                </div><?php } ?>
                ...
                <div class="alert alert-info alert-dismissible">
                  <h5><i class="icon fas fa-check"></i> Ups!</h5>
                  Ya no es valido crear cambios en la orden de compra</a>
                </div>
                </div>
                  <?php } ?>
              </div>
          ...
          <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">Finalizar orden de compra</h3>
            <div class="card-tools">
              <button type="button" class="btn btn-tool" data-card-widget="collapse">
                <i class="fas fa-minus"></i>
              </button>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" id="fechaEntregaMed" name="fechaEntregaMed" class="form-control" data-inputmask-alias="datetime" data-inputmask-inputformat="yyyy-mm-dd" data-mask value="<?php echo $hoy ?>">
                  </div>                
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label>Finalizar orden de compra</label>
                  <div class="input-group">
                    <input type="checkbox" name="finalizar" id="finalizar" data-bootstrap-switch data-off-color="danger" data-on-color="success" value="finalizar">
                  </div>               
                </div>
              </div>
              </div>
        ...
        <form name="add_name" id="add_name">
          <div class="table-responsive">
            <table class="table table-striped projects" id="dynamic_field" >
                <tr>
                    <th>Archivos acuses de entrega</th>
                    <th></th>
                </tr>
              <tr>
                <td>
                  <input type="hidden" id="idOrden" name="idOrden" value="<?php echo $idOrden ?>">
                  <input type="hidden" id="idServicio" name="idServicio" value="<?php echo $idServicio ?>">
            ...
            <button type="submit" class="btn btn-success">Enviar acuse de recibido de medicamentos</button>
          </div> 
          </div>
      </form>
...
$(document).ready(function(){
  ...
  $('#add').click(function(){
    i++;
    $('#dynamic_field').append('<tr id="row'+i+'"><td><input type="file" id="archivo" name="archivo[]" accept="application/pdf,application/vnd.ms-excel,image/gif,image/jpeg,,image/png"></td><td><button type="button" name="remove" id="'+i+'" class="btn btn-danger btn_remove">X</button></td></tr>');
  });
