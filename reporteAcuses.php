        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Reporte Acuses</li>
            </ol>
          </div>
        </div>
      </div>
          ...
          <table class="table table-striped projects" id="datosAcuse">
              <thead>
                  <tr>
                    ...
                    <th>
                          Fecha de entrega medicamentos
                      </th>
                      <th>
                          Fecha de envio acuse
                      </th>
                      <th>
                          Quien subio
                      </th>
              ...
              <tbody>
                <?php
                  ...
                  $query = "SELECT * from archivosacuses aa
                            ...
                            inner join servicios s on s.idServicio=aa.idServicio
                            inner join beneficiarios b on b.idBenefeciario=s.idBeneficiario
                            where fechaSubida between '$fechaInicio 00:00:01' and '$fechaFin 23:59:59'";
