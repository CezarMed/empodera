        ...
        <div class="card-body p-0">
          <table class="table table-striped projects">
              ...
              <tbody>
                ...
                $item=0; 
                $query="SELECT * from solicitudcotizaciones sc
                        ...
                        inner join tipoestatus te on te.idEstatus=sc.estatus
                        where sc.estatus=$estatus GROUP BY sc.idsolicitudMedicamentos";
                  ...
                  <tr>
                    ...
                    <td><font color="red"><b><?php echo $registro['descripcionEstatus'] ?></b></font>
                    </td>
                    <td>
