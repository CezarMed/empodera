...
include('class/altaDocumentosClientes.php');
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>BIBLIOTECA DE ARCHIVOS DEL CLIENTE</h1>
          </div>
          <div class="col-sm-6">
    ...
    <section class="content">
        ...
        <div class="card card-default">
         <form action="" method="POST" autocomplete="off" enctype="multipart/form-data">
          <div class="card-header">
            <h3 class="card-title">Archivos importantes del Cliente</h3>
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Biblioteca del cliente</h3>
          <div class="card-tools">
          ...
          <table class="table table-striped projects">
              ...
              <tbody>
                <?php
                  ...
                  $query = "SELECT * from clientesdocumentos s
