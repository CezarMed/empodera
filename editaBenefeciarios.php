  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>EDICION DE BENEFICIARIO</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Empodera</a></li>
              <li class="breadcrumb-item active">Edición de benefeciario</li>
            </ol>
          </div>
        </div>
      </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <input type="text" class="form-control" id="nombreBeneficiario" name="nombreBeneficiario" value="<?php echo $nombreBeneficiario ?>">
                    <input type="hidden" id="editaBenefeciarios" name="editaBenefeciarios" value="editaBenefeciarios">
                    <input type="hidden" id="idBeneficiario" name="idBeneficiario" value="<?php echo $idBenefeciario?>">
                    <input type="hidden" id="codigoBenefeciario" name="codigoBenefeciario" value="<?php echo $folio ?>">
                  </div>                
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <input type="text" class="form-control" id="folioBeneficiario" name="folioBeneficiario" value="<?php echo $folioBeneficiario ?>">
                  </div>                
                </div>
              </div>
            </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" id="fechaNac" name="fechaNac" class="form-control" data-inputmask-alias="datetime" data-inputmask-inputformat="yyyy-mm-dd" data-mask value="<?php echo $fechaNacimiento ?>">
                  </div>                
                </div>
              </div>
            </div>
      ...
      <div class="form-group">
          <div class="table-responsive">
            <table class="table table-bordered" id="dynamic_field">
              ...
              <tr>
                <td>                  
                  <input type="text" name="tipoTelefono[]" value="<?php echo $estados['tipoTelefono'] ?>" class="form-control name_list" /></td>
                <td><input type="text" name="telefonoadic[]" value="<?php echo $estados['telefono'] ?>" class="form-control name_list" /></td>
                <td><input type="text" name="extension[]" value="<?php echo $estados['extension'] ?>" class="form-control name_list" /></td>
              </tr>
            <?php } ?>
            </table>
          </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <textarea class="form-control" rows="3" id="referencias" name="referencias" placeholder="Referencias del domicilio"><?php echo $referencias ?></textarea>                
                </div>
              </div>
            </div>
          ...
          <div class="table-responsive">
            <table class="table table-bordered" id="dynamic_field">
              ...
              $res = mysqli_query($con,$query);
                while ($estados = mysqli_fetch_array($res)) { ?>
              <tr>
                <td><input type="hidden" name="idCuenta[]" value="<?php echo $estados['idCuenta'] ?>" class="form-control name_list" />
                  <input type="text" name="tipoTelefono[]" value="<?php echo $estados['nombreAcuerdo'] ?>" class="form-control name_list" readonly/></td>
                ...
                <td><select class="custom-select form-control-border" id="elegido" name="elegido[]" required>
                    ...
                    <option value="5">Quitar Cuenta</option>
                  </select></td>
              </tr>
            <?php } ?>
            </table>
  ...
  <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  $query = 'SELECT idCliente, nombreCliente from clientes where estatus=1';
                            $res = mysqli_query($con,$query);
                  ?>
                  <select class="custom-select form-control-border" id="idCliente" name="idCliente">
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <select class="custom-select form-control-border" id="subGrupoCliente" name="subGrupoCliente">
                  </select>
                </div>
              </div>
               <div class="col-md-3">
                <div class="form-group">
                  ...
                  <select class="custom-select form-control-border" id="subGrupoPrograma" name="subGrupoPrograma">
                  </select>
                </div>
              </div>
            </div>
            ...
            <?php if ($hoy>=$fechaFin) { ?>
              ...
              <div class="alert alert-danger alert-dismissible">
                  <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                  <h5><i class="icon fas fa-times"></i> IMPORTANTE!</h5>
                  El beneficiario no tiene un periodo valido para solicitar servicios</a>
              </div>
              </div>
              <div class="row">
              <div class="col-sm-6">
                    ...
                    <div class="form-group clearfix">
                      ...
                      <div class="icheck-primary d-inline">
                        <input type="checkbox" id="checkboxPrimary2" name="checkboxPrimary2" value="1" onchange="javascript:showContent()">
                        <label for="checkboxPrimary2">Agregar un nuevo periodo
                        </label>
                      </div>
                    </div>
                  </div>
            </div>
              <div class="row" id="nuevoPeriodo" id="name" style="display: none;">
              <div class="col-md-6">
                <div class="form-group">
                  <label>Fecha de inicio de cobertura</label>
                  <div class="input-group">
                    ...
                    <input type="text" id="fechaInicio" name="fechaInicio" class="form-control" data-inputmask-alias="datetime" data-inputmask-inputformat="yyyy-mm-dd" data-mask value="<?php echo $fechaInicial ?>">
                  </div>                
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" id="fechaFin" name="fechaFin" class="form-control" data-inputmask-alias="datetime" data-inputmask-inputformat="yyyy-mm-dd" data-mask value="<?php echo $fechaFin ?>">
                  </div>                
                </div>
              </div>
            </div>
            ...
            <button type="submit" class="btn btn-success">Actualizar expediente del beneficiario</button>
            </div>
            </div>
            </div>  
...
<script type="text/javascript">
    ...
    $.ajax({
      type: 'POST',
      url: 'consultas/consultasClientesGrupos2.php',
