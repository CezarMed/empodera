        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Clientes edición</li>
            </ol>
          </div>
        </div>
      </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                 ...
                 <input type="text" class="form-control" id="nombreCliente" name="nombreCliente" value="<?php echo $datoscliente['nombreCliente'] ?>">
                  <input type="hidden" class="form-control" id="nombreClienteAnt" name="nombreClienteAnt" value="<?php echo $datoscliente['nombreCliente'] ?>">
                 <input type="hidden" id="editaCliente" name="editaCliente" value="editaCliente">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="direccionCompleta" name="direccionCompleta" value="<?php echo $datoscliente['direccionCompleta'] ?>">
                  <input type="hidden" class="form-control" id="direccionCompletaAnt" name="direccionCompletaAnt" value="<?php echo $datoscliente['direccionCompleta'] ?>">
                </div>
              </div>
              <div class="col-md-6">
                 <div class="form-group">
                  <label>Código postal</label>
                  <input type="number" class="form-control" id="codigoPostal" name="codigoPostal" value="<?php echo $datoscliente['codigoPostal'] ?>">
                  <input type="hidden" class="form-control" id="codigoPostalAnt" name="codigoPostalAnt" value="<?php echo $datoscliente['codigoPostal'] ?>">
                </div>
              </div>
            </div>
          ...
          <div class="table-responsive">
            <table class="table table-bordered" id="dynamic_field2">
              <?php 
                  ...
                  <tr>
                <td>
                  <input type="hidden" name="idTelefono[]" value="<?php echo $extraidoCuentas['idTelefono'] ?>" class="form-control name_list" />
                  <input type="text" name="telefonox[]" value="<?php echo $extraidoCuentas['telefono'] ?>" class="form-control name_list" /></td>
                <td><input type="text" name="emailx[]" value="<?php echo $extraidoCuentas['email'] ?>" class="form-control name_list" /></td>
                <td></td>
              </tr>
                  <?php } ?>
              <tr>
        ...
        <form name="add_name" id="add_name">
          <div class="table-responsive">
            <table class="table table-striped projects" id="dynamic_field">
              ...
              <tr>
                <td>
                  <input type="hidden" name="idMontoCliente[]" value="<?php echo $extraidoCuentas['idMontoCliente'] ?>" class="form-control name_list" /><input type="text" name="programaant[]" value="<?php echo $extraidoCuentas['nombreAcuerdo'] ?>" class="form-control name_list" /></td>
                <td><input type="text" name="subgrupoant[]" value="<?php echo $extraidoCuentas['subgrupo'] ?>" class="form-control name_list" /></td>
                <td><input type="text" name="montoautorizadoclienteant[]" value="<?php echo $extraidoCuentas['montoautorizadocliente'] ?>" class="form-control name_list" /></td>
                <td><input type="text" name="contribucionant[]" value="<?php echo $extraidoCuentas['contribucion'] ?>" class="form-control name_list" /></td>
                <td><input type="text" name="copagoant[]" value="<?php echo $extraidoCuentas['copago'] ?>" class="form-control name_list" /></td>
                <td></td>
              </tr>
              <?php } ?>
              <tr>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                 ...
                 <input type="text" class="form-control" id="razonSocial" name="razonSocial" value="<?php echo $datosfactura['razonSocial'] ?>">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label>RFC</label>
                  <input type="text" class="form-control" id="rfc" name="rfc" value="<?php echo $datosfactura['rfc'] ?>">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label>Entidad Federativa</label>
                  <?php
                  if($entidadFederativaFacturacion==''){
                    $criterio='';
                    $criterio2='';
                  } else {
                    $criterio="where idEstado=".$entidadFederativaFacturacion;
                    $criterio2="where idEstado!=".$entidadFederativaFacturacion;
                  }
                  $queryEstados = "SELECT clave, nombreEstado from estados $criterio";
                  $resEstados = mysqli_query($con,$queryEstados);
                  $estadosResult= mysqli_fetch_array($resEstados);
                  $nombreEstado=$estadosResult['nombreEstado'];

                  $query = "SELECT clave, nombreEstado from estados $criterio2";
                  $res = mysqli_query($con,$query);
                  ?>
                  <select class="custom-select form-control-border" id="entidadFederativa2" name="entidadFederativa2">
                    <?php if ($entidadFederativaFacturacion!=0) { ?>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label>Dirección Completa</label>
                  <input type="text" class="form-control" id="direccionCompleta2" name="direccionCompleta2" value="<?php echo $datosfactura['direccion'] ?>">
              ...
              <div class="col-md-6">
                 <div class="form-group">
                  <label>Código postal</label>
                  <input type="number" class="form-control" id="codigoPostal2" name="codigoPostal2" value="<?php echo $datosfactura['cp'] ?>">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select class="custom-select form-control-border" id="tipoRegimen" name="tipoRegimen">
                    <?php if ($regimen=='01') { ?>
                    <option value="01">Fisica</option><option value="02">Moral</option><?php } ?>
                    <?php if ($regimen=='02') { ?>
                    <option value="02">Moral</option><option value="01">Fisica</option><?php } ?>

                    <?php if ($regimen=='') { ?>
                    <option value="">Selecciona una opción</option><option value="01">Fisica</option><option value="02">Moral</option><?php } ?>
                  </select>
