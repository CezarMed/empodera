...
if (array_key_exists('consultasActualizaciones', $_POST)) {
	...
	$sql="SELECT u.nombre, u.apellidos, mr.fechaMovimiento, mr.tipoMovimiento from movimientosminutas mr
INNER JOIN usuarios u on u.idUsuario=mr.idUsuario
where mr.idMinuta=$idRegister";
...
La minuta no tiene movimientos
</p>
</div>';
 } 
}
