...
if (array_key_exists('idcliente', $_POST)) {
	...
	$sql="SELECT u.nombre, u.apellidos, mr.fechaMovimiento, mr.tipoMovimiento from movimientosclientes mr
INNER JOIN usuarios u on u.idUsuario=mr.idUsuario
where mr.idCliente=$idcliente ORDER BY idMovimiento DESC";
...
El registro no tiene movimientos
</p>
</div>';
 } 
}
