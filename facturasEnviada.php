        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Facturas del proveedor enviada</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="card">
        ...
        <div class="card-body p-0">
          <table class="table table-striped projects">
              ...
              <tbody>
                <?php 
                            $query = "SELECT * from servicioscomplementos sc 
                            INNER JOIN facturasdatosxml fxml on fxml.idFacturas=sc.idFactura
                            where sc.idServicio=$idServicio and sc.idFactura!=0";
                            $res = mysqli_query($con,$query);
                            while ($registro = mysqli_fetch_array($res)) {
                  ?>
                  <tr>
                    <td>
                          <a href="<?php echo $registro['ArchivoXML'] ?>" target="_blanck">Ver Factura XML</a>
                      </td>
                      <td>
                          <a href="<?php echo $registro['ArchivoPDF'] ?>" target="_blanck">
                               Ver Factura PDF
                          </a>
                      </td>
                      <td>
                          <?php echo $registro['tipoPagoFactura'] ?>
                      </td>
                      <td>
                          <?php echo $registro['fechaSubeFactura'] ?>
                      </td>
                  </tr>
