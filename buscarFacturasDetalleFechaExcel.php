...
header("Content-Disposition: attachment; filename=reporteFacturasPaquete.xls");
          ...
          <table class="table table-striped projects">
              ...
              <tbody>
                ...
                $fechahasta=$_POST['fechahasta'];
                  $query = "SELECT gf.idGrupoFactura, gf.idFactura, s.folioEmpodera, b.nombreBeneficiario, fxml.tipoPagoFactura, s.servicio, tef.nombreEstatus, u.usuario, s.monto, fxml.nombreEmisor, fxml.rfcEmisor, fxml.FechaFactura, fxml.Folio, fxml.UUID, fxml.moneda, fxml.Total, imp.TotalImpuestosTrasladados, isr.TotalImpuestosRetenidos, reg.idBanco, reg.cuentaBancaria, reg.cuentaClabe, reg.idRegistro, gf.grupo, gf.idGrupoConsecutivo, fxml.fechaTimbrado, pfac.fechaSubePago, pfac.folioPago, fxml.fechaSubeFactura from gruposfacturas gf 
                  ...
                  left join pagosfacturas pfac on pfac.idFactura=gf.idFactura
                  where gf.fechaEnvioValidacion between '$fechadesde 00:00:01' and '$fechahasta 23:59:59' ";
                  ...
                  ?>
                      ...
                      <td><?php echo $registro['fechaSubePago'] ?></td>
                      <td><?php echo $registro['folioPago'] ?></td>
                      <td><?php echo $registro['fechaSubeFactura'] ?></td>
                  </tr>
                <?php } ?>
