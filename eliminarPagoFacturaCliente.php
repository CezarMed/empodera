      ...
      <div class="form-group">
          <div class="table-responsive">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                 <label for="exampleInputFile">Motivo para cancelar</label>
                  <div class="input-group">
          ...
          <div class="card-footer">
            <input type="hidden" id="idPagosFacturas" name="idPagosFacturas" value="<?php echo $extraidoBen['idPagoFactura'] ?>">
            ...
            <button type="submit" class="btn btn-danger">Quitar pago de factura</button>
          </div>
        </form>
        </div>
        </div>
