        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Video Tutoriales</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="timeline">
              <div>
                ...
                <div class="timeline-item">
                  <span class="time"><i class="fas fa-clock"></i> Empodera Salud</span>

                  <h3 class="timeline-header"><a href="#">Da clic en el botón  de PLAY para reproducir el video</a></h3>

                  <div class="timeline-body">
                    <div class="embed-responsive embed-responsive-16by9">
                      <video src="videos/<?php echo $video ?>.mp4" width=640  height=480 controls controlslist="nodownload">
