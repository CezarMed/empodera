    ...
    <section class="content">
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Listado de grupos de facturas a solicitar</h3>
        ...
        <div class="card-body p-0">
          <table class="table table-striped projects">
              ...
              <tbody>
                <?php 
                  $query="SELECT * from gruposfacturas where estatus=1 GROUP BY grupo, idGrupoConsecutivo";
                  ...
                  ?>
                      ...
                      <td><a class="btn btn-info btn-sm" href="verFacturasGrupos?grupo=<?php echo $registro['grupo'] ?>&idGrupo=<?php echo $registro['idGrupoConsecutivo'] ?>">
